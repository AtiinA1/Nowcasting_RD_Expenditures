...
# Load the data
df = pd.read_csv("/Users/atin/Nowcasting/data/Results/Combined_Evaluation/combined_all_results.csv")
...
#df = df[df['Sub-Model'] == 'AllVar']
#df = df[df['Country'] == 'CrossCountry']
#df = df[df['Lag'] == 3]  # Assuming Lag is stored as an integer
