...
merged_df.to_csv(f"/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model/AllVar/var_ly/gelu_5lyr_{hidden1_dim}_{hidden2_dim}/merged_df_test_RV01_batches_all_AggMGT_Evolution_0.csv")
#breakpoint()
...
X_all.to_csv(f"/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model/AllVar/var_ly/gelu_5lyr_{hidden1_dim}_{hidden2_dim}/X_all_AggMGT_Evolution.csv")
...
# X_train.to_csv(f"/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model/AllVar/var_ly/gelu_5lyr_{hidden1_dim}_{hidden2_dim}/X_train_std.csv")
...
class MLP(nn.Module): # MLP class from nn.Module/base class for all NN
    def __init__(self, input_dim, hidden1_dim, hidden2_dim, output_dim, num_countries, embedding_dim):
        ...
        self.fc3 = nn.Linear(hidden2_dim, output_dim, bias=True)
    ...
    def forward(self, x, country_indices):
        ...
        x = self.fc3(x)  # No activation at the output layer for regression tasks
...
class Ensemble:
    ...
    def train(self, X_train, y_train, X_val, y_val, country_indices_train, country_indices_val, criterion, optimizer_class, num_epochs=num_epochs, batch_size=batch_size, patience=patience):
        ...
        for idx, model in enumerate(self.models):
            ...
            best_model_path = f"/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model/AllVar/var_ly/gelu_5lyr_{hidden1_dim}_{hidden2_dim}/best_model_{idx}.pt"
...
# Save to CSV
csv_path = f"/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model/AllVar/var_ly/gelu_5lyr_{hidden1_dim}_{hidden2_dim}/ensemble_info.csv"
...
csv_path = f"/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model/AllVar/var_ly/gelu_5lyr_{hidden1_dim}_{hidden2_dim}/df_combined_pred_vs_true.csv"
...
for country in countries:
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f"/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model/AllVar/var_ly/gelu_5lyr_{hidden1_dim}_{hidden2_dim}/Predictions_vs_TrueValues_{country}.png")
...
def plot_scatter_per_country(df, title_prefix):
    ...
    for country in countries:
        ...
        plt.grid(True)
        plt.savefig(f"/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model/AllVar/var_ly/gelu_5lyr_{hidden1_dim}_{hidden2_dim}/Predictions_vs_TrueValues_scatter_{title_prefix}_{country}.png")        
        plt.show()
...
# Save back to CSV
metrics_df.to_csv(f"/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model/AllVar/var_ly/gelu_5lyr_{hidden1_dim}_{hidden2_dim}/metrics_df_minibatchGD.csv", index=False)
...
for idx, model_losses in enumerate(ensemble.train_losses):
    ...
    # Save to CSV
    df_train_loss.to_csv(f"/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model/AllVar/var_ly/gelu_5lyr_{hidden1_dim}_{hidden2_dim}/MLP_MinibatchGD_Training_Loss_Iterations_Model_{idx+1}.csv", index=False)
...
for idx, model_losses in enumerate(ensemble.val_losses):
    ...
    # Save to CSV
    df_val_loss.to_csv(f"/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model/AllVar/var_ly/gelu_5lyr_{hidden1_dim}_{hidden2_dim}/MLP_MinibatchGD_Validation_Loss_Iterations_Model_{idx+1}.csv", index=False)
...
for idx, model_losses in enumerate(ensemble.train_losses):
    ...
    plt.legend()
    plt.savefig(f"/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model/AllVar/var_ly/gelu_5lyr_{hidden1_dim}_{hidden2_dim}/MLP_MinibatchGD_Training_Loss_Iterations_Model_{idx+1}.png")
    #plt.show()
...
for idx, model_losses in enumerate(ensemble.val_losses):
    ...
    plt.legend()
    plt.savefig(f"/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model/AllVar/var_ly/gelu_5lyr_{hidden1_dim}_{hidden2_dim}/MLP_MinibatchGD_Validation_Loss_Iterations_Model_{idx+1}.png")
    #plt.show()
...
# Save to CSV
df.to_csv(f"/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model/AllVar/var_ly/gelu_5lyr_{hidden1_dim}_{hidden2_dim}/country_metrics.csv", index=False)
...
plt.savefig(f"/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model/AllVar/var_ly/gelu_5lyr_{hidden1_dim}_{hidden2_dim}/country_metrics_vis.png")
#plt.show()
...
csv_path_elasticities = f"/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model/AllVar/var_ly/gelu_5lyr_{hidden1_dim}_{hidden2_dim}/elasticities_avg_ensemble.csv"
df_elasticities_avg.to_csv(csv_path_elasticities, index=False)

csv_path_elasticities_raw = f"/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model/AllVar/var_ly/gelu_5lyr_{hidden1_dim}_{hidden2_dim}/elasticities_all_models.csv"
