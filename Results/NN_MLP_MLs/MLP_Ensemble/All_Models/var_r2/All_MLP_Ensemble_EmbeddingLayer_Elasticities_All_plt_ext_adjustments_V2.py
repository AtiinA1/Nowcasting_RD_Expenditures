...
class Ensemble:
    ...
    def train(self, X_train, y_train, X_val, y_val, country_indices_train, country_indices_val, criterion, optimizer_class, num_epochs=num_epochs, batch_size=batch_size, patience=patience):
        ...
        for idx, model in enumerate(self.models):
            ...
            best_model_path = f"/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model/AllVar/test10_ext_r2/best_model_{idx}.pt"
...
def plot_scatter_per_country(df, title_prefix):
    ...
    for country in countries:
        ...
        #plt.ylim(bottom=max(pred_min_val, true_min_val))  # Set the bottom to the higher of the two minimums
