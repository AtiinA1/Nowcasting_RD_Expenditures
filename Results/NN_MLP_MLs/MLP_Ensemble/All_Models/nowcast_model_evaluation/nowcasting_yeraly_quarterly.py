...
save_path = "/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model/MGTwRD/bem/test10-mlp-pytorch/Plots"
...
for country in countries:
    ...
    plt.figure(figsize=(10,5))
    plt.plot(subset['Year'] + (subset['Quarter'] - 1) * 0.25, subset['monthly_rd_expenditure'], label='True Value')
