...
for variation in model_variations:
    test2_dir = os.path.join(base_dir, variation, 'test2')
...
def plot_bar_metrics(metric):
    ...
    sns.barplot(data=combined_df, x='Model_Variation', y=metric, hue='Algorithm')
...
# Pivot the dataframe to format it suitably for a heatmap
heatmap_data = combined_df.pivot('Algorithm', 'Model_Variation', 'Test_RMSE')
...
# Pivot the dataframe to format it suitably for a heatmap
heatmap_data = combined_df.pivot('Algorithm', 'Model_Variation', 'Test_MAE')
