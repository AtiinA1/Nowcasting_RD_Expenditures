...
network = MLPRegressor(hidden_layer_sizes=(200, 20),
                       ...
                       tol=1e-4,
                       max_iter=100000,  # Maximum number of iterations. #For stochastic solvers (‘sgd’, ‘AdamW’), note that this determines the number of epochs (how many times each data point will be used), not the number of gradient steps.
