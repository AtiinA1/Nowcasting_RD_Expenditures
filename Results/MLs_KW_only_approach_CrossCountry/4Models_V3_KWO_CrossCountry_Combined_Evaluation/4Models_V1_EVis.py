...
# Load the data
df = pd.read_csv("/Users/atin/Nowcasting/data/Results/4Models_V3_KWO_CrossCountry_Combined_Evaluation/combined_results_V3_KWO.csv")
...
# Save the figure
plt.savefig('/Users/atin/Nowcasting/data/Results/4Models_V3_KWO_CrossCountry_Combined_Evaluation/combined_results_V3_KWO_boxplot1.png', dpi=300)
...
# Save the figure
plt.savefig('/Users/atin/Nowcasting/data/Results/4Models_V3_KWO_CrossCountry_Combined_Evaluation/combined_results_V3_KWO_boxplot2.png', dpi=300)
...
plt.tight_layout()
plt.savefig("/Users/atin/Nowcasting/data/Results/4Models_V3_KWO_CrossCountry_Combined_Evaluation/MAE_boxplot_common_V3_KWO_model_submodel_mae.png")
#plt.show()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig("/Users/atin/Nowcasting/data/Results/4Models_V3_KWO_CrossCountry_Combined_Evaluation/MAE_boxplot_common_V3_KWO_model_submodel_rmse.png")
#plt.show()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig("/Users/atin/Nowcasting/data/Results/4Models_V3_KWO_CrossCountry_Combined_Evaluation/MAE_boxplot_common_V3_KWO_model_submodel_mape.png")
#plt.show()
...
plt.tight_layout()
plt.savefig('/Users/atin/Nowcasting/data/Results/4Models_V3_KWO_CrossCountry_Combined_Evaluation/combined_results_V3_barplot2_mae_model_subm_lag.png', dpi=300)
#plt.show()
...
plt.xticks(rotation=90)
plt.tight_layout()
plt.savefig('/Users/atin/Nowcasting/data/Results/4Models_V3_KWO_CrossCountry_Combined_Evaluation/combined_results_V3_barplot2_rmse_model_subm_lag.png', dpi=300)
#plt.show()
...
plt.xticks(rotation=90)
plt.tight_layout()
plt.savefig('/Users/atin/Nowcasting/data/Results/4Models_V3_KWO_CrossCountry_Combined_Evaluation/combined_results_V3_barplot2_mape_model_subm_lag.png', dpi=300)
#plt.show()
