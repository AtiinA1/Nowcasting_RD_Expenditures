...
if all_dfs:
    ...
    # Save to CSV
    combined_df.to_csv('/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model_Evaluations/test10/final_evaluation.csv', index=False)
else:
...
def plot_bar_metrics(metric):
    ...
    sns.barplot(data=combined_df_rev, x='Algorithm', y=metric, hue='Model_Variation')
    ...
    # Save the figure
    plt.savefig(f'/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model_Evaluations/test10/barplot_{metric}.png', bbox_inches='tight')
    plt.show()
...
filtered_df = combined_df[(combined_df['Algorithm']!= 'ElasticNet')]
...
plt.savefig(f'/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model_Evaluations/test10/heatmap_mape.png', bbox_inches='tight')
plt.show()
...
plt.savefig(f'/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model_Evaluations/test10/heatmap_RMSE.png', bbox_inches='tight')
plt.show()
...
plt.title('MAPE Heatmap across Model Variations and Algorithms')
plt.savefig(f'/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model_Evaluations/test10/heatmap_maE.png', bbox_inches='tight')
plt.show()
