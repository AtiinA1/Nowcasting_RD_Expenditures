...
# Load the data
df = pd.read_csv('/Users/atin/Nowcasting/data/Results/AggMGT_Evolution/MLP_Ensemble_10_Final/XGBoost_MLP_Meta_Model/MGTwRD/test10_ext_ensemblesize10/df_combined_pred_vs_true.csv')
...
results_df.to_csv('/Users/atin/Nowcasting/data/Results/Cleanedup/ErrorTest/statistical_test_results_errorterm_MGTwRD_alltype.csv')
...
plt.title('Histogram of Residuals')
plt.savefig('/Users/atin/Nowcasting/data/Results/Cleanedup/ErrorTest/Histogram_residuals_MGTwRD.png')
plt.show()
...
plt.xlabel('Predicted Values')
plt.ylabel('Residuals')
plt.savefig('/Users/atin/Nowcasting/data/Results/Cleanedup/ErrorTest/scatter_MGTwRD.png')
plt.show()
...
plt.title('Autocorrelation Plot of Residuals')
plt.savefig('/Users/atin/Nowcasting/data/Results//Cleanedup/ErrorTest/autocorrelation_MGTwRD.png')
...
results_df.to_csv('/Users/atin/Nowcasting/data/Results/Cleanedup/ErrorTest/statistical_test_results_errorterm_MGTwRD_train_residuals.csv')
