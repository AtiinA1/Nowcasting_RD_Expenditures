...
for lag in range(1, max_lag+1):
    ...
    # Filtering the datasets using the important features
    #X_train_filtered = X_train_lag[important_cols_poly]
    #X_val_filtered = X_val_lag[important_cols_poly]
    #X_test_filtered = X_test_lag[important_cols_poly]
    ...
    # Now, filter the DataFrames using only important polynomial columns
    X_train_filtered = X_train_lag_df[important_cols_poly]
    X_val_filtered = X_val_lag_df[important_cols_poly]
    X_test_filtered = X_test_lag_df[important_cols_poly]
