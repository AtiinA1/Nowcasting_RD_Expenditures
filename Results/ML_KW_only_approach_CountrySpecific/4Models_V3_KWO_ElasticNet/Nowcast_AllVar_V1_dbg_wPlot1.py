...
df_trends_monthly_aggregated.to_csv('/Users/atin/Nowcasting/data/Results/4Models_V3_KWO_ElasticNet/AllVar/df_trends_monthly_YTD.csv')
...
df_trends_monthly_aggregated.to_csv('/Users/atin/Nowcasting/data/Results/4Models_V3_KWO_ElasticNet/AllVar/df_trends_monthly_YTD_YR.csv')
print(df_trends_monthly_aggregated.columns)
...
merged_df.to_csv('/Users/atin/Nowcasting/data/Results/4Models_V3_KWO_ElasticNet/AllVar/merged_df.csv')
...
merged_df.to_csv(f"/Users/atin/Nowcasting/data/Results/4Models_V3_KWO_ElasticNet/AllVar/merged_df_test_RV01_batches_all_{model_name}_0.csv")
...
for country in X_all['Country'].unique():
    ...
    for lag in range(1, max_lag+1):
        ...
        #model_coeff.to_csv(f"/Users/atin/Nowcasting/data/Results/4Models_V3_KWO_ElasticNet/AllVar/model_coeff_{country}_{lag}.csv")
        ...
        plt.savefig(f"/Users/atin/Nowcasting/data/Results/4Models_V3_KWO_ElasticNet/AllVar/model_scatter_train_{model_name}_{country}_{lag}.png")
        #plt.show()

        sns.set_theme(color_codes=True)
        fig, ax = plt.subplots(figsize=(10, 8), nrows=1, ncols=1)
        plt.hist(y_train_country['residuals'])
        plt.savefig(f"/Users/atin/Nowcasting/data/Results/4Models_V3_KWO_ElasticNet/AllVar/model_residuals_train_{model_name}_{country}_{lag}.png")
        #plt.show()
        ...
        plt.savefig(f"/Users/atin/Nowcasting/data/Results/4Models_V3_KWO_ElasticNet/AllVar/model_scatter_test_{model_name}_{country}_{lag}.png")
        #plt.show()
    
        sns.set_theme(color_codes=True)
        fig, ax = plt.subplots(figsize=(10, 8), nrows=1, ncols=1)
        plt.hist(y_test_country['residuals'])
        plt.savefig(f"/Users/atin/Nowcasting/data/Results/4Models_V3_KWO_ElasticNet/AllVar/model_residuals_test_{model_name}_{country}_{lag}.png")
        #plt.show()
...
merged_df.to_csv(f"/Users/atin/Nowcasting/data/Results/4Models_V3_KWO_ElasticNet/AllVar/merged_df_test_RV01_batches_all_{model_name}.csv")
...
evaluation_train_df.to_csv(f"/Users/atin/Nowcasting/data/Results/4Models_V3_KWO_ElasticNet/AllVar/evaluation_batches_train_{model_name}.csv", index=False)
evaluation_test_df.to_csv(f"/Users/atin/Nowcasting/data/Results/4Models_V3_KWO_ElasticNet/AllVar/evaluation_testAGT1_{model_name}.csv", index=False)
