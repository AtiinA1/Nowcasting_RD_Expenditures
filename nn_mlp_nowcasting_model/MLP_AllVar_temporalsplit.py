...
df_trends_monthly_aggregated.to_csv('/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/df_trends_monthly_YTD.csv')
...
df_trends_monthly_aggregated.to_csv('/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/df_trends_monthly_YTD_YR.csv')
print(df_trends_monthly_aggregated.columns)
...
merged_df.to_csv('/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/merged_df.csv')
...
merged_df.to_csv(f"/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/merged_df_test_RV01_batches_all_AggMGT_Evolution_0.csv")
...
X_all.to_csv(f"/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/X_all_AggMGT_Evolution.csv")
...
X_train.to_csv(f"/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/X_train_OHC_Month_Cat_Country.csv")
...
X_train.to_csv(f"/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/X_train_std.csv")
...
class Ensemble:
    ...
    def train(self, X_train, y_train, X_val, y_val, country_indices_train, country_indices_val, criterion, optimizer_class, num_epochs=num_epochs, batch_size=batch_size, patience=patience):
        ...
        for idx, model in enumerate(self.models):
            ...
            best_model_path = f"/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/best_model_{idx}.pt"
...
# Save to CSV
csv_path = "/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/ensemble_info.csv"
...
adjusted_r_squared_csv_path = "/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/adjusted_r_squared_values.csv"
...
csv_path = "/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/df_combined_pred_vs_true.csv"
...
def plot_scatter_per_country(df, title_prefix):
    ...
    for country in countries:
        ...
        plt.grid(True)
        plt.savefig(f"/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/{title_prefix}_Predictions_vs_TrueValues_{country}.pdf")        
    ...
    plt.savefig(f"/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/{title_prefix}_Predictions_vs_TrueValues_Combined.pdf")
    plt.close()  # Close the individual plot
...
def plot_scatter_per_country_log(df, title_prefix):
    ...
    for country in countries:
        ...
        plt.grid(True)
        plt.yscale('log')
        plt.savefig(f"/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/{title_prefix}_Predictions_vs_TrueValues_{country}_log.pdf")        
        plt.close()  # Close the individual plot
    ...
    plt.yscale('log')
    plt.legend(title="Country")
    plt.savefig(f"/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/{title_prefix}_Predictions_vs_TrueValues_Combined_log.pdf")
    plt.close()  # Close the individual plot
...
# Save back to CSV
metrics_df.to_csv("/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/metrics_df_minibatchGD.csv", index=False)
...
for idx, model_losses in enumerate(ensemble.train_losses):
    ...
    # Save to CSV
    df_train_loss.to_csv(f"/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/MLP_MinibatchGD_Training_Loss_Iterations_Model_{idx+1}.csv", index=False)
...
for idx, model_losses in enumerate(ensemble.val_losses):
    ...
    # Save to CSV
    df_val_loss.to_csv(f"/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/MLP_MinibatchGD_Validation_Loss_Iterations_Model_{idx+1}.csv", index=False)
...
for idx, model_losses in enumerate(ensemble.train_losses):
    ...
    plt.savefig(f"/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/MLP_MinibatchGD_Training_Loss_Iterations_Model_{idx+1}.pdf")
    #plt.show()
...
for idx, model_losses in enumerate(ensemble.val_losses):
    ...
    plt.savefig(f"/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/MLP_MinibatchGD_Validation_Loss_Iterations_Model_{idx+1}.pdf")
    #plt.show()
...
# Save to CSV
df.to_csv("/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/country_metrics.csv", index=False)
...
for model in df['Models'][0]:
    ...
    plt.savefig(f"/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/country_metrics_vis_{model}.pdf")
    #plt.show()
...
csv_path_elasticities_avg_wyr = "/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/elasticities_avg_ensemble_wyr.csv"
df_elasticities_avg_wyr.to_csv(csv_path_elasticities_avg_wyr, index=False)

# Save to CSV if needed
csv_path_elasticities_avg_woyr = "/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/elasticities_avg_ensemble_woyr.csv"
df_elasticities_avg_woyr.to_csv(csv_path_elasticities_avg_woyr, index=False)

csv_path_elasticities_raw = "/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/elasticities_all_models.csv"
...
# Create DataFrames from the adjusted SHAP values and save to CSV
df_shap_train = pd.DataFrame(shap_values_train_adj, columns=feature_names)
df_shap_train.to_csv('/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/shap_values_train.csv', index=False)

df_shap_val = pd.DataFrame(shap_values_val_adj, columns=feature_names)
df_shap_val.to_csv('/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/shap_values_val.csv', index=False)

df_shap_test = pd.DataFrame(shap_values_test_adj, columns=feature_names)
df_shap_test.to_csv('/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/shap_values_test.csv', index=False)


#SHAP Summary plot
plt.figure()
shap.summary_plot(shap_values_train_adj, X_train_df, show=False)
plt.savefig("/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/shap_summary_train.pdf", bbox_inches='tight')

plt.figure()
shap.summary_plot(shap_values_train_adj, X_train_df, plot_type="bar", show=False)
plt.savefig("/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/shap_bar_train_bar.pdf", bbox_inches='tight')

plt.figure()
shap.summary_plot(shap_values_val_adj, X_val_df, show=False)
plt.savefig("/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/shap_summary_val.pdf", bbox_inches='tight')

plt.figure()
shap.summary_plot(shap_values_val_adj, X_val_df, plot_type="bar", show=False)
plt.savefig("/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/shap_bar_val_bar.pdf", bbox_inches='tight')

plt.figure()
shap.summary_plot(shap_values_test_adj, X_test_df, show=False)
plt.savefig("/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/shap_summary_test.pdf", bbox_inches='tight')

plt.figure()
shap.summary_plot(shap_values_test_adj, X_test_df, plot_type="bar", show=False)
plt.savefig("/Users/atin//Nowcasting/nn_mlp_nowcasting_model/results/temporal_split/AllVar/shap_bar_test_bar.pdf", bbox_inches='tight')
